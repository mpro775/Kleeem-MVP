      ...
      <Box sx={{ p: 1, overflowY: "auto" }}>
        ...
        <List disablePadding>
          {filtered.map((s: any, i) => {
            ...
            const unread: number | undefined = s.unread; // اختياري
            const pinned: boolean | undefined = s.pinned; // اختياري
            const typing: boolean | undefined = s.typing; // اختياري
