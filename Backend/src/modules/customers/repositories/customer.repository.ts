...
export interface CustomerRepository {
  ...
  findByEmailLower(emailLower: string, merchantId: string): Promise<Customer | null>;
  findByPhoneNormalized(phoneNormalized: string, merchantId: string): Promise<Customer | null>;
  findByContact(contact: string, contactType: 'phone' | 'email', merchantId: string): Promise<Customer | null>;
