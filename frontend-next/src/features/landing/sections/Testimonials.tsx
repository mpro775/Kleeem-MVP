...
import { testimonials } from "@/features/landing/data/testimonialsData";
    ...
    >
      ...
      <Box sx={{ position: "relative", mx: "auto", maxWidth: 1400 }}>
        <Box
          ...
          sx={{
            "--slide-spacing": "16px",
            "--slide-size": { xs: "86%", sm: "48%", md: "32%" } as React.CSSProperties, // ✅ كارد واحد وسط على الموبايل
          }}
        >
          {/* viewport */}
          <Box
