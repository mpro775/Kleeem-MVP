...
// Type for window with KaleemChat
interface WindowWithKaleemChat extends Window {
  KaleemChat?: {
    open?: () => void;
  };
}
          ...
          <Grid size={{xs:12}}>
            <Stack direction="row" alignItems="center" spacing={2}>
              ...
              <Tooltip title="افتح دردشة كليم">
                <IconButton onClick={() => { 
                  const kaleemWindow = window as WindowWithKaleemChat;
                  if (kaleemWindow.KaleemChat?.open) kaleemWindow.KaleemChat.open(); 
                }} size="large">
                  <SupportAgentIcon />
                </IconButton>
              </Tooltip>
