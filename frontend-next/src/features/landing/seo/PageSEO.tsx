...
export default function PageSEO({
  ...
  }, [title, description, keywords, canonical, ogImage, ogType, twitterCard, noIndex, structuredData, breadcrumbs, articleData, updateMetaTag, updateCanonical, addBreadcrumbs, addStructuredData]);
