...
import { setBrandVars } from '@/features/shared/brandPalette';
...
import type { Category } from '@/features/merchant/categories/types';
import type { Storefront } from '@/features/merchant/storefront-theme/types';
              ...
              <Card key={o._id} sx={{ borderRadius: 3, overflow: 'hidden' }}>
                ...
                <CardActions sx={{ justifyContent: 'flex-end', px: 2, pb: 2 }}>
                  <Button
                    ...
                    onClick={() =>
                      router.push(`/${locale}/store/${slug}/order/${o._id}`)
                    }
                  >
                    عرض التفاصيل
                  </Button>
